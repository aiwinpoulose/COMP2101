...
test -f /etc/resolv.conf && echo "/etc/resolv.conf exists and its a regular file" || echo "/etc/resolv.conf is not a regular file"
test -h /etc/resolv.conf && echo "/etc/resolv.conf exists and its a symbolic link" || echo "/etc/resolv.conf is not a symbolic link"
test -d /etc/resolv.conf && echo "/etc/resolv.conf exists and its a directory" || echo "/etc/resolv.conf is not a directory"
test -r /etc/resolv.conf && echo "/etc/resolv.conf exists and its a readable" || echo "/etc/resolv.conf is not readable"
test -w /etc/resolv.conf && echo "/etc/resolv.conf exists and its writable" || echo "/etc/resolv.conf is not writable"
test -f /etc/resolv.conf && echo "/etc/resolv.conf exists and its executable" || echo "/etc/resolv.conf is not executable"
